...
task1 = Task.create(title: '1', body: 'Groceries', user_id: 1)
task2 = Task.create(title: '2',body: 'Homework', user_id: 1)
task3 = Task.create(title: '3', body: 'Do the dishes', user_id: 2)
task4 = Task.create(title: '4', body: 'Eat', user_id: 3)
task5 = Task.create(title: '5', body: 'Meow World Meow', user_id: 3)