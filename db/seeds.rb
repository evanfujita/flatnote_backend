...
task1 = Task.create(title: 'first', description: 'Hello World', user_id: 1)
task2 = Task.create(title: 'second',description: 'Hello World Hello World', user_id: 1)
task3 = Task.create(title: 'third', description: 'Hola World', user_id: 2)
task4 = Task.create(title: 'meow', description: 'Meow World', user_id: 3)
task5 = Task.create(title: 'meow2', description: 'Meow World Meow', user_id: 3)